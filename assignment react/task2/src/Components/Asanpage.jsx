...
function Asanpage1() {
  return (
    ...
    <Container >
    <h1 className="d-flex justify-content-center align-items-center " style={{  marginTop:'80px' }}>Connect With Our Digital Marketing Experts</h1><br></br>
     <p className="d-flex justify-content-center align-items-center" >Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ab, harum nesciunt vitae similique odio eius magnam sequi earum ducimus architecto sapiente cumque, laborum cum</p>
      <Row className="justify-content-center my-5">
        <Col xs={19} md={8}>
          ...
          <Form style={{  marginTop:'80px', backgroundColor: 'white', paddingLeft:'20px', paddingRight:'10px',height:'40vh',  width:'90vh'}}>
